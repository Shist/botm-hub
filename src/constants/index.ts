...
export const CATEGORIES_COLORS: Record<OsuMapCategory, string> = {
  [OsuMapCategory.NM1]: "var(--color-btn-bg-nm1)",
  [OsuMapCategory.NM2]: "var(--color-btn-bg-nm2)",
  [OsuMapCategory.NM3]: "var(--color-btn-bg-nm3)",
  [OsuMapCategory.NM4]: "var(--color-btn-bg-nm4)",
  [OsuMapCategory.NM5]: "var(--color-btn-bg-nm5)",
  [OsuMapCategory.NM6]: "var(--color-btn-bg-nm6)",
  [OsuMapCategory.NM7]: "var(--color-btn-bg-nm7)",
  [OsuMapCategory.HD1]: "var(--color-btn-bg-hd1)",
  [OsuMapCategory.HD2]: "var(--color-btn-bg-hd2)",
  [OsuMapCategory.HD3]: "var(--color-btn-bg-hd3)",
  [OsuMapCategory.HR1]: "var(--color-btn-bg-hr1)",
  [OsuMapCategory.HR2]: "var(--color-btn-bg-hr2)",
  [OsuMapCategory.HR3]: "var(--color-btn-bg-hr3)",
  [OsuMapCategory.DT1]: "var(--color-btn-bg-dt1)",
  [OsuMapCategory.DT2]: "var(--color-btn-bg-dt2)",
  [OsuMapCategory.DT3]: "var(--color-btn-bg-dt3)",
  [OsuMapCategory.DT4]: "var(--color-btn-bg-dt4)",
  [OsuMapCategory.FM1]: "var(--color-btn-bg-fm1)",
  [OsuMapCategory.FM2]: "var(--color-btn-bg-fm2)",
  [OsuMapCategory.FM3]: "var(--color-btn-bg-fm3)",
  [OsuMapCategory.TB]: "var(--color-btn-bg-tb)",
};
